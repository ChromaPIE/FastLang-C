package com.chromapie.fastlangc.asm;
...
public class FastLangClassTransformer implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        if (!transformedName.equals("net.minecraft.client.gui.GuiLanguage$List")) return basicClass;
                        ...
                        if (minsn.owner.equals(MINECRAFT) && minsn.desc.equals("()V")) {
                            ...
                            method.instructions.insertBefore(
                                ...
                                new MethodInsnNode(
                                    ...
                                    "com/chromapie/fastlangc/asm/FastLangClassTransformer",
                                    "inject",
                                    "()V",
                                    false));
